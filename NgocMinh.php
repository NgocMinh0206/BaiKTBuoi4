...
<html>
    <body>
        ...
        <h2 style="text-align: center">-------------------Lưu Ngọc Minh---------------------</h2>
        <?php
        echo "Câu 1: ";
